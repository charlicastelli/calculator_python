...
class Calculator:
    ...
    def create_operator_buttons(self):
        ...
        for operator, symbol in self.operations.items():
            button = tk.Button(self.buttons_frame, text=symbol, bg=GREY_21, fg=WHITE, font=DEFAULT_FONT_STYLE,
    ...
    def create_clear_button(self):
        button = tk.Button(self.buttons_frame, text="C", bg=GREY_21, fg=WHITE, font=DEFAULT_FONT_STYLE,
    ...
    def create_square_button(self):
        button = tk.Button(self.buttons_frame, text="x\u00b2", bg=GREY_21, fg=WHITE, font=DEFAULT_FONT_STYLE,
    ...
    def create_equals_button(self):
        button = tk.Button(self.buttons_frame, text="=", bg=STEEL_BLUE, fg=WHITE, font=DEFAULT_FONT_STYLE,
